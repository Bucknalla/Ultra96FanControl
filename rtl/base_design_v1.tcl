...
set overlay_name "ultra96_fan"
set list_projs [get_projects -quiet]
if { $list_projs eq "" } {
   create_project ${overlay_name} -part xczu3eg-sbva484-1-i
}

# CHANGE DESIGN NAME HERE
variable design_name
set design_name ultra96_fan
...
bucknalla:misc:Not:1.0\
bucknalla:misc:ultra96_fan_control:1.0\
"
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set BT_HCI_CTS [ create_bd_port -dir I BT_HCI_CTS ]
  set BT_HCI_RTS [ create_bd_port -dir O BT_HCI_RTS ]
  set FAN_PWM [ create_bd_port -dir O FAN_PWM ]
  set UART0_ctsn [ create_bd_port -dir I UART0_ctsn ]
  set UART0_rtsn [ create_bd_port -dir O UART0_rtsn ]
...
#   create_bd_cell -type ip -vlnv user.org:user:Not:1.0 Not_1
  set block_cell_name Not_0
  if { [catch {set Not_0 [create_bd_cell -type ip -vlnv bucknalla:misc:Not:1.0 -name $block_cell_name] } errmsg] } {
  ...
  # Create instance: Ultra96_fan_control_0, and set properties
  set block_cell_name Ultra96_fan_control_0
  if { [catch {set Ultra96_fan_control_0 [create_bd_cell -type ip -vlnv bucknalla:misc:ultra96_fan_control:1.0 -name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Ultra96_fan_control_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set_property -dict [ list \
   ...
   CONFIG.SYSMONE1_STARUP_SELECTION {single_channel} \
   CONFIG.TEMPERATURE_ALARM_OT_RESET {0} \
   CONFIG.TEMPERATURE_ALARM_OT_TRIGGER {85} \
   CONFIG.TEMPERATURE_ALARM_RESET {70} \
   CONFIG.TEMPERATURE_ALARM_TRIGGER {75} \
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins Ultra96_fan_control_0/s00_axi] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net BT_HCI_CTS_1 [get_bd_ports BT_HCI_CTS] [get_bd_pins zynq_ultra_ps_e_0/emio_uart0_ctsn]
  connect_bd_net -net Not_0_nA [get_bd_pins Not_0/nA] [get_bd_pins system_management_wiz_0/reset_in]
  connect_bd_net -net Ultra96_fan_control_0_pwm_out [get_bd_ports FAN_PWM] [get_bd_pins Ultra96_fan_control_0/pwm_out]
  ...
  connect_bd_net -net ctsn_0_1 [get_bd_ports UART0_ctsn] [get_bd_pins axi_uart16550_0/ctsn]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins Ultra96_fan_control_0/s00_axi_aresetn] [get_bd_pins axi_uart16550_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN]
  connect_bd_net -net sin_0_1 [get_bd_ports UART0_rxd] [get_bd_pins axi_uart16550_0/sin]
  connect_bd_net -net system_management_wiz_0_do_out [get_bd_pins Ultra96_fan_control_0/temp_in] [get_bd_pins system_management_wiz_0/do_out]
  ...
  connect_bd_net -net system_management_wiz_0_user_temp_alarm_out [get_bd_pins Ultra96_fan_control_0/temp_alarm_in] [get_bd_pins system_management_wiz_0/user_temp_alarm_out]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins system_management_wiz_0/daddr_in] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_uart0_rtsn [get_bd_ports BT_HCI_RTS] [get_bd_pins zynq_ultra_ps_e_0/emio_uart0_rtsn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins Ultra96_fan_control_0/s00_axi_aclk] [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins system_management_wiz_0/dclk_in] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins Not_0/A] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

  # Create address segments
  create_bd_addr_seg -range 0x00001000 -offset 0x80000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs Ultra96_fan_control_0/s00_axi/reg0] SEG_Ultra96_fan_control_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x80010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_uart16550_0/S_AXI/Reg] SEG_axi_uart16550_0_Reg
...
make_wrapper -files [get_files ./warc_cores_fan_control_0.0.1.srcs/sources_1/bd/ultra96_fan/ultra96_fan.bd] -top
add_files -norecurse ./warc_cores_fan_control_0.0.1.srcs/sources_1/bd/ultra96_fan/hdl/ultra96_fan_wrapper.v
set_property top ultra96_fan_wrapper [current_fileset]
set_property synth_checkpoint_mode Singular [get_files ./warc_cores_fan_control_0.0.1.srcs/sources_1/bd/ultra96_fan/ultra96_fan.bd]
generate_target all [get_files  ./warc_cores_fan_control_0.0.1.srcs/sources_1/bd/ultra96_fan/ultra96_fan.bd]

import_files -fileset constrs_1 -norecurse $script_folder/ultra96v1.xdc
